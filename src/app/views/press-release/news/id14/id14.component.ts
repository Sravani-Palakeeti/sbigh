...
@Component({
  selector: 'app-id14',
  templateUrl: './id14.component.html',
  styleUrls: ['./id14.component.scss']
})
export class Id14Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[13].content
      this.gallery = this.PressRelease[13].galleryData[0].images
    })
  }
