...
@Component({
  selector: 'app-id29',
  templateUrl: './id29.component.html',
  styleUrls: ['./id29.component.scss']
})
export class Id29Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[28].content
      this.gallery = this.PressRelease[28].galleryData[0].images
    })
  }
