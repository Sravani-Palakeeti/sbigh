...
@Component({
  selector: 'app-id27',
  templateUrl: './id27.component.html',
  styleUrls: ['./id27.component.scss']
})
export class Id27Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[26].content
      this.gallery = this.PressRelease[26].galleryData[0].images
    })
  }
