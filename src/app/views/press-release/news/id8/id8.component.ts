...
@Component({
  selector: 'app-id8',
  templateUrl: './id8.component.html',
  styleUrls: ['./id8.component.scss']
})
export class Id8Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[7].content
      this.gallery = this.PressRelease[7].galleryData[0].images
    })
  }
