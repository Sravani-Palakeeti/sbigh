...
@Component({
  selector: 'app-id32',
  templateUrl: './id32.component.html',
  styleUrls: ['./id32.component.scss']
})
export class Id32Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[31].content
      this.gallery = this.PressRelease[31].galleryData[0].images
    })
  }
