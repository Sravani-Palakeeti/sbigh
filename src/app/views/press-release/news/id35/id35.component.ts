...
@Component({
  selector: 'app-id35',
  templateUrl: './id35.component.html',
  styleUrls: ['./id35.component.scss']
})
export class Id35Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[34].content
      this.gallery = this.PressRelease[34].galleryData[0].images
    })
  }
