...
@Component({
  selector: 'app-id6',
  templateUrl: './id6.component.html',
  styleUrls: ['./id6.component.scss']
})
export class Id6Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[5].content
      this.gallery = this.PressRelease[5].galleryData[0].images
    })
  }
