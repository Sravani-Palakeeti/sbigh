...
@Component({
  selector: 'app-id34',
  templateUrl: './id34.component.html',
  styleUrls: ['./id34.component.scss']
})
export class Id34Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[33].content
      this.gallery = this.PressRelease[33].galleryData[0].images
    })
  }
