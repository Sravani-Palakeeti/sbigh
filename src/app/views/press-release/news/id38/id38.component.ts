...
@Component({
  selector: 'app-id38',
  templateUrl: './id38.component.html',
  styleUrls: ['./id38.component.scss']
})
export class Id38Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[37].content
      this.gallery = this.PressRelease[37].galleryData[0].images
    })
  }
