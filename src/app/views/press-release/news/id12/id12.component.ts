...
@Component({
  selector: 'app-id12',
  templateUrl: './id12.component.html',
  styleUrls: ['./id12.component.scss']
})
export class Id12Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[11].content
      this.gallery = this.PressRelease[11].galleryData[0].images
    })
  }
