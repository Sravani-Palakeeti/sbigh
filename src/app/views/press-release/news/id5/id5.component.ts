...
@Component({
  selector: 'app-id5',
  templateUrl: './id5.component.html',
  styleUrls: ['./id5.component.scss']
})
export class Id5Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[4].content
      this.gallery = this.PressRelease[4].galleryData[0].images
    })
  }
