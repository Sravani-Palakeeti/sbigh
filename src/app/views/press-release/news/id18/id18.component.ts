...
@Component({
  selector: 'app-id18',
  templateUrl: './id18.component.html',
  styleUrls: ['./id18.component.scss']
})
export class Id18Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[17].content
      this.gallery = this.PressRelease[17].galleryData[0].images
    })
  }
