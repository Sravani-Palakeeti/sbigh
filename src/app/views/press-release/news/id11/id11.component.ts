...
@Component({
  selector: 'app-id11',
  templateUrl: './id11.component.html',
  styleUrls: ['./id11.component.scss']
})
export class Id11Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[10].content
      this.gallery = this.PressRelease[10].galleryData[0].images
    })
  }
