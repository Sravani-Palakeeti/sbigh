...
@Component({
  selector: 'app-id39',
  templateUrl: './id39.component.html',
  styleUrls: ['./id39.component.scss']
})
export class Id39Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[38].content
      this.gallery = this.PressRelease[38].galleryData[0].images
    })
  }
