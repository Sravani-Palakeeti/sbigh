...
@Component({
  selector: 'app-id26',
  templateUrl: './id26.component.html',
  styleUrls: ['./id26.component.scss']
})
export class Id26Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[25].content
      this.gallery = this.PressRelease[25].galleryData[0].images
    })
  }
