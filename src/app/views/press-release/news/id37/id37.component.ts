...
@Component({
  selector: 'app-id37',
  templateUrl: './id37.component.html',
  styleUrls: ['./id37.component.scss']
})
export class Id37Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[36].content
      this.gallery = this.PressRelease[36].galleryData[0].images
    })
  }
