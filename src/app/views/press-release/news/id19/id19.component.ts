...
@Component({
  selector: 'app-id19',
  templateUrl: './id19.component.html',
  styleUrls: ['./id19.component.scss']
})
export class Id19Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[18].content
      this.gallery = this.PressRelease[18].galleryData[0].images
    })
  }
