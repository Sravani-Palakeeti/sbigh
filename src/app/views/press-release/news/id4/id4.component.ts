...
@Component({
  selector: 'app-id4',
  templateUrl: './id4.component.html',
  styleUrls: ['./id4.component.scss']
})
export class Id4Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[3].content
      this.gallery = this.PressRelease[3].galleryData[0].images
    })
  }
