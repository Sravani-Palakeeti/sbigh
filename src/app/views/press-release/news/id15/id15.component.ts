...
@Component({
  selector: 'app-id15',
  templateUrl: './id15.component.html',
  styleUrls: ['./id15.component.scss']
})
export class Id15Component implements OnInit {
  ...
  getpage(){
    this.pressRelease.list().subscribe(res => {
      ...
      this.htmlStr = this.PressRelease[14].content
      this.gallery = this.PressRelease[14].galleryData[0].images
    })
  }
