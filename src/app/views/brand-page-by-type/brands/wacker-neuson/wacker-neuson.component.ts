...
@Component({
  selector: 'app-wacker-neuson',
  templateUrl: './wacker-neuson.component.html',
  styleUrls: ['./wacker-neuson.component.scss']
})
export class WackerNeusonComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[12].content
      this.gallery = this.BrandDetails[12].galleryData[0].images  
    })
  }
