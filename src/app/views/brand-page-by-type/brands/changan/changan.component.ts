...
@Component({
  selector: 'app-changan',
  templateUrl: './changan.component.html',
  styleUrls: ['./changan.component.scss']
})
export class ChanganComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[4].content
      this.gallery = this.BrandDetails[4].galleryData[0].images
