...
@Component({
  selector: 'app-autorent',
  templateUrl: './autorent.component.html',
  styleUrls: ['./autorent.component.scss']
})
export class AutorentComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[20].content
      this.gallery = this.BrandDetails[20].galleryData[0].images  
    })
  }
