...
@Component({
  selector: 'app-baic',
  templateUrl: './baic.component.html',
  styleUrls: ['./baic.component.scss']
})
export class BAICComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[5].content
      this.gallery = this.BrandDetails[5].galleryData[0].images
