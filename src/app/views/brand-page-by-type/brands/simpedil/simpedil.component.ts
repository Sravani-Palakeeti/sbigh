...
@Component({
  selector: 'app-simpedil',
  templateUrl: './simpedil.component.html',
  styleUrls: ['./simpedil.component.scss']
})
export class SimpedilComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[15].content
      this.gallery = this.BrandDetails[15].galleryData[0].images  
    })
  }
