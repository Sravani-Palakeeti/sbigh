...
@Component({
  selector: 'app-iveco',
  templateUrl: './iveco.component.html',
  styleUrls: ['./iveco.component.scss']
})
export class IvecoComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[7].content
      this.gallery = this.BrandDetails[7].galleryData[0].images
