...
@Component({
  selector: 'app-deta',
  templateUrl: './deta.component.html',
  styleUrls: ['./deta.component.scss']
})
export class DetaComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[18].content
      this.gallery = this.BrandDetails[18].galleryData[0].images  
    })
  }
