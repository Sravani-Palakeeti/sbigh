...
@Component({
  selector: 'app-tcm-forklift',
  templateUrl: './tcm-forklift.component.html',
  styleUrls: ['./tcm-forklift.component.scss']
})
export class TcmForkliftComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[11].content
      this.gallery = this.BrandDetails[11].galleryData[0].images
