...
@Component({
  selector: 'app-foton',
  templateUrl: './foton.component.html',
  styleUrls: ['./foton.component.scss']
})
export class FotonComponent implements OnInit {
  ...
  async getbrand() {
    this.brands.list().subscribe(res => {
      ...
      this.htmlStr = this.BrandDetails[6].content
      this.gallery = this.BrandDetails[6].galleryData[0].images
